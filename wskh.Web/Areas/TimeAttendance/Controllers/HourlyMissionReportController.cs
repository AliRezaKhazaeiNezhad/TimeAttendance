...
{
    public class HourlyMissionReportController : Controller
    {
        #region Propertices
        ...
        #region Ctor
        public HourlyMissionReportController(IUserService userService, IUserGroupService userGroupService)
        {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.MenuName = $"hourlymissionReport";
            return View();
        }
        #endregion
        #region Search
        ...
        private static void PrepareLeaveGridModel(HourlyLeaveReportModel sessionModel, List<HourlyLeaveGridModel> modelList, List<UserGroup> list)
        {
            ...
            if (allRequests != null)
                allRequests = allRequests.Where(x => x.State == RequestState.Approved && x.Type == RequestType.MissionHourly).ToList();
