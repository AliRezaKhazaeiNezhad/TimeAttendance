...
{
    public class AnalyzedReportController : Controller
    {
        #region Propertices
        ...
        public AnalyzedReportController(IAnalyzedReportService analyzedReportService, IUserService userService)
        {
        ...
        {
            ViewBag.MenuName = $"analyzedreport";
            return View();
        }
        #endregion
        ...
        #region List
        [HttpGet]
        public ActionResult ListIndex(int groupId = 0, string userId = null, string stDate = null, string edDate = null)
        {
            ...
            try
            {
                ...
                if (userList != null)
                {
                    foreach (var user in userList)
                    {
                        ...
                        list = _analyzedReportService.List(userId, geoSTDate.GetValueOrDefault(), geoEDDate.GetValueOrDefault());
        ...
        {
            var entity = _analyzedReportService.FindById(id);
