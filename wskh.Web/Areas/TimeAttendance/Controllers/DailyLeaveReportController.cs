...
{
    public class DailyLeaveReportController : Controller
    {
        #region Propertices
        ...
        public DailyLeaveReportController(IUserService userService, IUserGroupService userGroupService)
        {
        ...
        {
            ViewBag.MenuName = $"dailyleaveReport";
            return View();
        }
        #endregion
        #region Search
        ...
        private static void PrepareLeaveGridModel(HourlyLeaveReportModel sessionModel, List<HourlyLeaveGridModel> modelList, List<UserGroup> list)
        {
            ...
            if (allRequests != null)
                allRequests = allRequests.Where(x => x.State == RequestState.Approved && x.Type == RequestType.DailyRest).ToList();
