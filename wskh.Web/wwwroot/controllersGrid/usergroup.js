    ...
    "columnDefs": [
        {
            ...
            render: function (data, type, row, meta) {
                return '<div class="dropdown mPointer"><button class="btn btn-dark btn-sm dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="true">عملیات<span class="caret"></span></button><ul class="dropdown-menu"><li onclick="CustomeDelete(\'/UserGroup/Delete?id=' + data + '\')"><span class="dropdown-item "> حذف </span></li><li onclick="GetEmptyView(\'/TimeAttendance/UserGroup/AddOrUpdate?id=' + data + '\', \'AddOrUpdate-Part\')"><span class="dropdown-item "> ویرایش </span></li><li onclick="GetContracts(' + data +')"><span class="dropdown-item "> انتساب شیفت کاری</span></li></ul></div>';
            }
        }
    ],
...
function GetContracts($id) {
    $.ajax({
        url: "/TimeAttendance/UserGroup/GetContracts?id=" + $id,
        type: 'Get',
        dataType: "html",
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    if (data == 0) {
                                        ...
                                        Message(1, "این گروه دارای کاربر بوده و امکان حذف وجود ندارد");
                                    }
                                    else  if (data == -1) {
