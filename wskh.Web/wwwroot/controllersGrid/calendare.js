    ...
    "columnDefs": [
        {
            ...
            render: function (data, type, row, meta) {
                return '<div class="dropdown mPointer"><button class="btn btn-dark btn-sm dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="true">عملیات<span class="caret"></span></button><ul class="dropdown-menu"><li onclick="Delete(\'/Calendare/Delete?id=' + data + '\')"><span class="dropdown-item "> حذف </span></li><li><a  href="/TimeAttendance/Calendare/Create?id=' + data + '"><span class="dropdown-item "> ویرایش </span></a></li></ul></div>';
            }
        }
    ],
    "order": [[0, "asc"]]
...
function GetProgram(id) {
    $.ajax({
        url: "/TimeAttendance/Calendare/GetProgram?id=" + id,
        type: 'get',
        dataType: "html",
